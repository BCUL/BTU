...
// Copyright (c) 2013 The Bitcoin Unlimited developers
...
uint256 hashGenesisBlock("0x000007b9b7201c1f5d33e634e8f860e4cb4481fae0cf62f48ab9f0c81ae44c4b");
static const unsigned int timeGenesisBlock = 1491029432;
...
int64 static GetBlockValue(int nHeight, int64 nFees, unsigned int nBits)
{
	...
	if (nHeight > 1 && nHeight <= 525600 ) 
		nSubsidy = 25 * COIN;
	
	if (nHeight > 525600 && nHeight <= 1154400 ) 
		nSubsidy = 12.5 * COIN;
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        // Genesis block
        const char* pszTimestamp = "2017. The BitcoinUnlimited release. ";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.print();
        assert(block.hashMerkleRoot == uint256("0xbc0139166935ff98e167069574f81b0a7238ebc1a1d6dbb61f50e1297a48f2b5"));
...
unsigned char pchMessageStart[4] = { 0x62, 0x5c, 0x22, 0x3f };
...
void static BitcoinMiner(CWallet *pwallet)
{
    ...
    RenameThread("BitcoinUnlimited-miner");
