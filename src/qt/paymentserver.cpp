...
const QString BITCOIN_IPC_PREFIX("Bitcoin Unlimited:");
...
{
    QString name("Bitcoin UnlimitedQt");
...
{
    // Install global event filter to catch QFileOpenEvents on the mac (sent when you click Bitcoin Unlimited: links)
    ...
    if (!uriServer->listen(name))
        qDebug() << tr("Cannot start Bitcoin Unlimited: click-to-pay handler");
    else
...
{
    // clicking on Bitcoin Unlimited: URLs creates FileOpen events on the Mac:
